...
export default function DetectedProductDetailsScreen({route}) {
    const item_name=route.params.name
    const description=route.params.description
    const price=route.params.price
    image_data=route.params.images
    ...
    return (
      ...
      <View>
        ...
        <Text style={{fontSize:30,fontWeight:"500",color:"white" ,marginTop:2,marginBottom:2}}>{item_name}</Text>
         <Text style={{color:"blue",marginTop:10,marginBottom:2}}><Text style={{fontSize:15,fontWeight:"bold" ,color:"white",marginTop:10,marginBottom:2}}>Description: </Text>{description}</Text>
         <Text style={{color:"blue",marginTop:10,marginBottom:2}}><Text style={{fontSize:15,fontWeight:"bold" ,color:"white",marginTop:10,marginBottom:2}}>Price: Rs</Text> {price}</Text>
  
         <View  style={{flexDirection:"row",alignItems:"center", alignContent:"space-between",marginTop:5, marginTop:10 , marginBottom:5}}>
  <TouchableOpacity style={{margin:5,backgroundColor:"green",width:100,color:"white",alignItems:"center",padding:2,borderRadius:4,marginRight:2}} onPress={OnAddtoCartPressed} >
      <Text style={{padding:2,color:"white",fontSize:15}}>Add to cart</Text>
  </TouchableOpacity>
  <TouchableOpacity style={{margin:5,backgroundColor:"blue",width:120,color:"white",alignItems:"center",padding:2,borderRadius:4,marginRight:2 }} onPress={OnAddtoWishlistPressed}>
      <Text style={{padding:2,color:"white" ,fontSize:15}}>Add to WishList</Text>
  </TouchableOpacity>
  
  <TouchableOpacity style={{ margin:5,backgroundColor:"grey",width:120,color:"white",alignItems:"center",padding:2,borderRadius:4,marginRight:2 }} onPress={onViewPressed}>
